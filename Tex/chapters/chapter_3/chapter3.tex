...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/graficoLDA_k50_saf_mor_gha_ni}
	\caption{Evolución de componentes. Selección de países africanos. Exportaciones}
	\label{fig:graficoldak50safmorghani}
\end{figure}
