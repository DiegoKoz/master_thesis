...
En primer lugar, en la figura \ref{fig:rel_dep}, analizamos la frecuencia de las interacciones entre países en función de su valor comercial y la proporción del comercio que representan para el país importador. Ambas distribuciones tienen una asimetría a derecha, que asemeja una distribución de chi-cuadrado. En la figura \ref{fig:rel_dep-1} se puede observar que si bien la gran mayoría de las relaciones bilaterales de comercio representan una baja proporción de las importaciones de un determinado país, existen ciertas relaciones comerciales que se podrían caracterizar como de alta dependencia para el país importador. 
...
\begin{figure}
	\centering
%	\subfigure[Según porcentaje de impo. que representa al país importador]{\label{fig:Interacciones-1}\includegraphics[width=.65\linewidth]{2016_freq_interacciones_3}}
	\subfigure[Según valor comercial]{\label{fig:Interacciones-2}\includegraphics[width=.65\linewidth]{2016_freq_interacciones_0}}
...
\begin{figure}[h!]
	\centering
	\subfigure[Grado]{\label{fig:paises_LP-a}\includegraphics[width=0.7\linewidth]{1950_2000_impo_densidad_ARG_BRA_MEX_grado}}
	\subfigure[Autovalor Ponderado]{\label{fig:paises_LP-b}\includegraphics[width=0.7\linewidth]{1950_2000_impo_densidad_ARG_BRA_MEX_atvlrpnd}}
...
\begin{figure}[h!]
	\centering
	\subfigure[China y Estados Unidos]{\label{fig:paises_ASI_LP-a}\includegraphics[width=0.7\linewidth]{1950_2000_impo_densidad_USAvsCHN_autovalor_x_yr}}
	\subfigure[Japón,Corea y China]{\label{fig:paises_ASI_LP-b}\includegraphics[width=0.7\linewidth]{1950_2000_impo_densidad_CHN_JPN_ROK_atvlr}}
