...
\begin{figure}
	...
	\caption{Interacciones Según porcentaje de importaciones que representa al país importador. Destacado par Importador-Exportador}
	\label{fig:rel_dep}
\end{figure}
