...
\begin{figure}
	\centering
	\subfigure[2016]{\label{fig:rel_destacadas-1}\includegraphics[width=.65\linewidth]{2016_freq_interacciones_0}}
	\subfigure[Top 5 por año]{\label{fig:rel_destacadas-2}\includegraphics[width=.65\linewidth]{relaciones_destacadas_EDA}}
...
\begin{figure}[h!]
	\centering
	\subfigure[Coeficiente de Clustering.]{\label{fig:metricas_LP-a}\includegraphics[width=.48\linewidth]{1950_2000_coef_clustering_x_yr}}
	\subfigure[Correlación de grado]{\label{fig:metricas_LP-b}\includegraphics[width=.48\linewidth]{1950_2000_correlacion_x_yr}}
