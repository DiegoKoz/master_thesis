...
\begin{figure}
	\centering
	\subfigure[1\%]{\includegraphics[width=0.45\linewidth]{grafo_2016_1_pcnt_wgt_Circ}}
	\subfigure[5\%]{\includegraphics[width=0.45\linewidth]{grafo_2016_5_pcnt_wgt_Circ}}
	\subfigure[10\%]{\includegraphics[width=0.45\linewidth]{grafo_2016_10_pcnt_wgt_Circ}}
	\subfigure[15\%]{\includegraphics[width=0.45\linewidth]{grafo_2016_15_pcnt_wgt_Circ}}
	\subfigure[20\%]{\includegraphics[width=0.45\linewidth]{grafo_2016_20_pcnt_wgt_Circ}}
	\subfigure[25\%]{\includegraphics[width=0.45\linewidth]{grafo_2016_25_pcnt_wgt_Circ}}
...
\begin{figure}
	\centering
	\subfigure[1\%]{\includegraphics[width=0.45\linewidth]{dist_ac_2016_1_pcnt}}
	\subfigure[5\%]{\includegraphics[width=0.45\linewidth]{dist_ac_2016_5_pcnt}}
	\subfigure[10\%]{\includegraphics[width=0.45\linewidth]{dist_ac_2016_10_pcnt}}
	\subfigure[15\%]{\includegraphics[width=0.45\linewidth]{dist_ac_2016_15_pcnt}}
	\subfigure[20\%]{\includegraphics[width=0.45\linewidth]{dist_ac_2016_20_pcnt}}
	\subfigure[25\%]{\includegraphics[width=0.45\linewidth]{dist_ac_2016_25_pcnt}}
	\caption{\textbf{Distribución acumulada del grado. 2016, según punto de corte. Importaciones}}
	\label{fig:dist_ac_grado}
\end{figure}

\begin{figure}
	\centering
	\subfigure[5\%]{\includegraphics[width=0.48\linewidth]{corr_grados_2016_5_pcnt}}
	\subfigure[15\%]{\includegraphics[width=0.48\linewidth]{corr_grados_2016_15_pcnt}}
	\subfigure[25\%]{\includegraphics[width=0.48\linewidth]{corr_grados_2016_25_pcnt}}
...
\begin{figure}
	\centering
	\subfigure[Número de aristas]{\includegraphics[width=.45\linewidth]{naristas_x_yr}}
	\subfigure[Grado promedio]{\includegraphics[width=.45\linewidth]{mean_degree_x_yr}}
	\subfigure[Cercanía promedio]{\includegraphics[width=.45\linewidth]{mean_closeness_x_yr}}
	\subfigure[Máxima intermediación]{\includegraphics[width=.45\linewidth]{max_betweenness_x_yr}}
	\subfigure[Intermediación promedio]{\includegraphics[width=.45\linewidth]{mean_betweenness_x_yr}}
	\subfigure[Autovalor promedio]{\includegraphics[width=.45\linewidth]{mean_eigen_centrality_x_yr}}
	\subfigure[Autovalor promedio. Ponderado por valor comercial]{\includegraphics[width=.45\linewidth]{mean_eigen_centrality_ponderado_x_yr}}
	\caption{\textbf{Importaciones.} umbral 1\%. 1996-2016}
...
\begin{figure}[h!]
	\centering
	\subfigure[Número de aristas]{\includegraphics[width=.45\linewidth]{1950_2000_naristas_x_yr}}
	\subfigure[Diámetro]{\includegraphics[width=.45\linewidth]{1950_2000_diametro_x_ano}}	\subfigure[Correlación]{\includegraphics[width=.45\linewidth]{1950_2000_correlacion_x_yr}}	\subfigure[Grado medio]{\includegraphics[width=.45\linewidth]{1950_2000_mean_degree_x_yr}}	\subfigure[cercanía promedio]{\includegraphics[width=.45\linewidth]{1950_2000_mean_closeness_x_yr}}		\caption{Evolución de la estructura de la red. Importaciones. Umbral 1\%.1948-2000}
	\label{fig:metricas_LP_comp}
\end{figure}

\begin{figure}[h!]
	\centering
	\subfigure[Intermediación máxima]{\includegraphics[width=.45\linewidth]{1950_2000_max_betweenness_x_yr}}	
	\subfigure[Intermediación media]{\includegraphics[width=.45\linewidth]{1950_2000_mean_betweenness_x_yr}}
	\subfigure[Autovalor promedio]{\includegraphics[width=.45\linewidth]{1950_2000_mean_eigen_centrality_x_yr}}
	\subfigure[Autovalor promedio. Ponderado por valor comercial]{\includegraphics[width=.45\linewidth]{1950_2000_mean_eigen_centrality_ponderado_x_yr}}	
	\caption{Evolución de la estructura de la red. Importaciones. Umbral 1\%.1948-2000}
	\label{fig:metricas_LP_comp}
\end{figure}
...
\begin{figure}
	\centering
	\subfigure[1966]{\includegraphics[width=0.45\linewidth]{mapa_projection_walktrap_lp_1966}}
	\subfigure[1976]{\includegraphics[width=0.45\linewidth]{mapa_projection_walktrap_lp_1976}}
	\subfigure[1986]{\includegraphics[width=0.45\linewidth]{mapa_projection_walktrap_lp_1986}}
	\subfigure[1996]{\includegraphics[width=0.45\linewidth]{mapa_projection_walktrap_lp_1996}}
	\subfigure[2016]{\includegraphics[width=0.5\linewidth]{mapa_projection_walktrap_lp_2016}}
...
\begin{figure}
	\centering
	\subfigure[1966]{\includegraphics[width=0.45\linewidth]{mapa_walktrap_lp_1966}}
	\subfigure[1976]{\includegraphics[width=0.45\linewidth]{mapa_walktrap_lp_1976}}
	\subfigure[1986]{\includegraphics[width=0.45\linewidth]{mapa_walktrap_lp_1986}}
	\subfigure[1996]{\includegraphics[width=0.45\linewidth]{mapa_walktrap_lp_1996}}
	\subfigure[2016]{\includegraphics[width=0.45\linewidth]{mapa_walktrap_2016}}
