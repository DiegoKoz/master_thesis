...
- Basados en Teoría de Grafos (@Hidalgo2009) 

- Basados en Modelos generativos (@LDA)
...
El concepto de _product space_  surge de @Hidalgo2007

<img style="float: left;" src="www/TheProductSpace.png" alt="Espacio de productos" width="600px"/>
...
- Para ello, nos basamos en el modelo propuesto por @LDA, que fue originalmente pensado para encontrar __dimensiones subyacentes__ en un corpus de texto, comprendido como los _tópicos de los que habla el texto_. 
...
- La idea de definir clusters donde cada producto puede pertenecer a más de un grupo (difusos) tambien esta basada en @molinari2016especializacion
...
<img style="float: left;" src="www/swissRoll.png" alt="Espacio de productos" width="600px"/>
...
<img style="float: right;" src="www/dirichlet.png" alt="Espacio de productos" width="600px"/>
...
<img style="float: center;" src="www/grafo_variational.png" alt="Espacio de productos" width="1000px"/>
