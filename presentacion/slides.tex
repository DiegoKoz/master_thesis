...
\begin{columns}[c] 
	...
	\begin{itemize}[label=\faRebel]
		...
		\item Se puede proyectar a un grafo de productos, donde la relación de cercanía se define a partir de qué países los exportan
		\item También se puede proyectar a un grafo de productos, donde la relación de cercanía surge por la similitud de sus canastas exportadoras.
	\end{itemize}
